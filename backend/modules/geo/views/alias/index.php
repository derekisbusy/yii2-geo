...
/* @var $searchModel derekisbusy\geo\models\GeoCityAliasSearch */
...
$this->title = Yii::t('geo', 'City Aliases');
...
//        },
        ...
        'filterInputOptions' => ['placeholder' => 'State', 'id' => 'grid-geo-alias-search-state_id']
    ],
    [
        'attribute' => 'status',
        'value' => function($model){
        ...
        'format' => 'raw',
        'filterType' => GridView::FILTER_SELECT2,
        'filter' => GeoCityAlias::getStatusOptions(),
        'filterWidgetOptions' => [
            'pluginOptions' => ['allowClear' => true],
        ],
        'filterInputOptions' => ['placeholder' => 'Status', 'id' => 'grid-geo-alias-search-status']
    ],
    [
...
echo Html::beginTag('div', ['class'=>'geo-alias-index']);
$gridId = 'geo-alias-grid';
echo DynaGrid::widget([
    'columns' => $columns,
    'options' => ['id' => 'geo-alias-dynagrid'],
    ...
    'gridOptions'=>[
        ...
        'responsive' => true,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-geo-alias']],
        'hover' => true,
        'condensed' => true,
        'floatHeader' => true,
        'floatHeaderOptions' => [
        ...
        'panel' => [
            ...
            'type' => 'info',
            'before' => Html::a('<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('geo', 'New Alias'), ['create'], ['class' => 'btn btn-success']), 
            'showFooter' => true,
            'after' => 
                ...
                Html::a('<i class="glyphicon glyphicon-trash"></i> Delete', ['delete-multiple'], [
                    ...
                    'data-confirm-message' => Yii::t('geo', 'Are you sure you want to delete these {item}?', ['item' => Yii::t('geo', 'aliases')]),
                    'data-grid' => $gridId,
                    ...
                    'items' => [
                        ['label' => Yii::t('geo','Active'), 'url' => 'javascript:;', 
                            'linkOptions' => [
                                ...
                                'data-pjax-container' => '#geo-alias-dynagrid-pjax',
