    ...
    'attributes' => [
        ...
        'county_id' => [
            ...
            'options' => [
                ...
                'options' => ['placeholder' => Yii::t('geo', 'Choose Geo county')],
            ],
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  Yii::t('geo', 'Delete'), 'onClick' => 'delRowGeoZip(' . $key . '); return false;', 'id' => 'geo-zip-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
