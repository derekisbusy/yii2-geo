...
<div class="geo-state-view">
    ...
    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('derekisbusy/geo', 'Geo State').' '. Html::encode($this->title) ?></h2>
        </div>
...
if($providerGeoCounty->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
            'type' => GridView::TYPE_PRIMARY,
            'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode(Yii::t('derekisbusy/geo', 'Geo County')),
        ],
        'export' => false,
