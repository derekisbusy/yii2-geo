...
/* @var $searchModel vendor\derekisbusy\geo\models\GeoCitySearch */
...
<div class="geo-city-index">
    ...
    <p>
        <?= Html::a(Yii::t('derekisbusy/geo', 'Create Geo City'), ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Geo state', 'id' => 'grid-geo-city-search-state_id']
            ],
        [
                'attribute' => 'county_id',
                ...
                'filterInputOptions' => ['placeholder' => 'Geo county', 'id' => 'grid-geo-city-search-county_id']
            ],
        [
